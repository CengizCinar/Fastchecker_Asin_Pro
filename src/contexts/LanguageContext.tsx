  ...
  const getLanguageTexts = () => {
    const texts = {
      en: {
        ...
        'upgradeForMonthlyReport': 'Upgrade your plan to access monthly bulk query reports',
      ...
      tr: {
        ...
        'upgradeForMonthlyReport': 'Aylik toplu sorgu raporlarına erismek icin planınızı yukseltin',
