    ...
    const texts = {
      en: {
        ...
        'back': 'Back',
            ...
            'notFoundInMarketplace': 'Not Available in Marketplace',
            'notFoundInMarketplaceDesc': 'This ASIN does not exist in the selected marketplace',
            'unknown': 'Unknown',
            'checkError': 'Error',
            'cancel': 'Cancel',
            'confirm': 'Confirm',
      ...
      tr: {
        ...
        'back': 'Geri',
            ...
            'notFoundInMarketplace': 'Bu Pazaryerinde Bulunmuyor',
            'notFoundInMarketplaceDesc': 'Bu ASIN seçili pazaryerinde mevcut değil',
            'unknown': 'Bilinmiyor',
            'checkError': 'Hata',
            'cancel': 'İptal',
            'confirm': 'Onayla',
